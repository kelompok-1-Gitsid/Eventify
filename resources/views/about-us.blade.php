<x-user-layout>
    <div class="w-full h-[20rem] my-20 text-center">
    ...
    <div class="image absolute inset-y-44 -z-10 ml-20 hidden lg:block">
        <img src="{{ url('assets/img/about-us.jpg') }}" alt="">
    </div>
    <div class="flex flex-col items-center justify-center footer">
