<nav class="w-full fixed z-20 p-2 top-0 start-0 bg-white font-plusJakarta shadow-md">
    <div class="max-w-screen flex flex-wrap justify-between mx-[2rem] lg:mx-[8rem] p-4">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul
                class="flex flex-col p-4 md:p-0 mt-4 font-bold border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                <li>
                    <a href="{{ url('/') }}"
            ...
            @else
                <button type="button" data-modal-target="authetication-modal"
                    class="bg-slate-300 text-slate-900 hover:bg-cyan hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2 text-center">
                    <a href="{{ route('login') }}" class="font-medium">Log in</a>
                </button>
                @if (Route::has('register'))
                    <button type="button" data-modal-target="authetication-modal"
                        class="ml-2 bg-blue-700 text-slate-50 hover:text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2 text-center">
