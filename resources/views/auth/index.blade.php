        ...
        <div class="w-[950px] h-[580px] left-0 top-0 absolute bg-slate-50 rounded-[13px] shadow">
            ...
            <div class="container flex flex-row mt-4">
                <div class="basis-1/2">
                    <form action="" method="post">
                        <div class="mt-4 ml-6 font-plusJakarta">
                            ...
                            <div class="flex w-[24rem] mt-2 rounded-md shadow-sm ring-1 ring-inset ring-gray-300">
                                <input type="text" name="" id="" class="block flex-1 border-0 bg-transparent py-2 pl-2.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="mt-4 ml-6 font-plusJakarta">
                            <label for="">Password</label>
                            <div class="flex w-[24rem] mt-2 rounded-md shadow-sm ring-1 ring-inset ring-gray-300">
                                <input type="password" name="" id="" class="block flex-1 border-0 bg-transparent py-2 pl-2.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    ...
                    <div class="ml-6 mt-8 w-[24rem] font-plusJakarta">
