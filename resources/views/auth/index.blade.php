...
<div class="w-full h-screen bg-white justify-center items-center flex">
    ...
    <div class="flex min-h-full flex-col justify-center font-plusJakarta">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
          <h2 class="mt-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Welcome back</h2>
          <p class="mt-2 text-center font-medium">We are so happy, u come back</p>
        </div>

        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form class="space-y-6" action="#" method="POST">
            {{-- Email Or Username Form --}}
            <div>
              <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email address or username</label>
              <div class="mt-2">
                <x-input-text type="text" name="email" required value="{{ Session::get('email') }}" class="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"/>
            ...
            <div>
              ...
              <div class="my-4 text-end">
                <a href="" class="text-sm text-bluelight hover:text-blue-500">Forgot your password?</a>
              </div>
            </div>
            {{-- Submit --}}
            <div>
              <button type="submit" class="flex w-full justify-center rounded-md bg-cyan px-3 py-2 text-sm leading-6 shadow-sm hover:bg-blue-500 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500">Log in</button>
            </div>
          </form>
          <div class="">
            <p class="mt-4 mb-4 text-sm text-gray-500">
                Need an account?
                <a href="#" class="font-semibold leading-6 text-bluelight hover:text-blue-500 ml-1">Register</a>
            </p>
