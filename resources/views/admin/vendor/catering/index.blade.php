                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('catering.show', $product->id) }}" class="btn btn-warning" title="Edit data">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form onsubmit="return deleteData('{{ $product->name }}')" action="{{ route('catering.destroy', $product->id) }}" method="post" class="d-inline">
                                        @csrf
                                        @method('DELETE')
