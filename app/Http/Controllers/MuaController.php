...
class MuaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.vendor.mua.index', compact('user'));
    }
    ...
    public function create()
    {
        $user = User::where('role', 'vendor')
            ...
            ->get();
        return view('admin.vendor.mua.product', compact('user'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mua.index')->with('success', 'Product has been successfully created');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.vendor.mua.edit', compact('id', 'data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $user = User::find($id);
        if (!$user) {
            return redirect()->route('mua.index')->with('error', 'User not found');
        }

        $product = Product::where('user_id', $id)->first();
        if (!$product) {
            return redirect()->route('mua.index')->with('error', 'Product not found');
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('mua.index')->with('msg', 'Category has been successfully deleted');
    }
}
